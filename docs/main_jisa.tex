...
certify the Rust implementation line by line. ProVerif is used in
...
\textbf{Interlanguage layer} & External API adapter and protocol invocation & 2026 & client and server pipelines \\
\midrule
