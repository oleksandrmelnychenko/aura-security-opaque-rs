...
- Swift imports `EcliptixOPAQUEBinary` directly and exposes `generateKE1(password:accountId:state:)`.
...
- `dist/apple/EcliptixOPAQUE.xcframework.zip`
- `dist/apple/EcliptixOPAQUE.xcframework.zip.checksum`
